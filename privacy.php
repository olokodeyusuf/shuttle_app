...
<html>
<head>
<title>FPI SHUTTLE BUS TRANSPORT | Privacy & Policy :: w3layouts</title>
<link href="bus.png" rel="icon">
...
<div class="header">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a href="index.html">FPI SHUTTLE <span>BUS</span></a>	
		</div>
		<div class="bus wow fadeInUp animated" data-wow-delay=".5s">
            <a href="index.html" class="buses active">BUSES</a>
            <a href="hotels.html"></a>
        </div>
...
<!--- footer-top ----><div class="footer-top">
	<div class="container">
		<div class="col-md-6 footer-left wow fadeInLeft animated" data-wow-delay=".5s">
			<h3>Bus Operators</h3>
				<ul>
					<li><a href="bus.html">AUD/ MARKET CHATER</a></li>
...
<div class="copy-right">
	<div class="container">
		...
		<p class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">© FPI SHUTTLE . All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">Olokode Yusuf</a> </p>
	</div>
</div>
<!--- /copy-right ---->
<!-- sign -->
