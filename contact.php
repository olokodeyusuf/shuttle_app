...
<html>
<head>
<title>FPI SSHUTTLE BUS TRANSPORT | Contact :: w3layouts</title>
	...
	<h3>Contact Us</h3>
		<div class="col-md-3 contact-left">
			<div class="con-top animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp;">
				<h4>FPI SHUTTLE PARK EAST CAMPUS </h4>
		<li>East campus opposite ICT/MULTIMEDIA LABORATORY</li>
		<a href="#" data-toggle="modal" data-target="#myModal3">lodge<u> complaint</u></a>
			<div class="tra-top">
			</div>
			<div class="con-top animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp;">
